package com.liwenyao.coolweather.db;
...
/**
 * Created by liwenyao on 2015/11/25.
 */
public class CoolWeatherOpenHelper extends SQLiteOpenHelper {
     ...
     * County表建表语句
     */
    public static final String CREATTE_COUNTY = "create table County(id integer primary key autoincrement, county_name text, county_name text, city_id integer)";
